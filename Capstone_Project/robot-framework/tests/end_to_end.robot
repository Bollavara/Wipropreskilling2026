...
End User Session
    # This specifically checks if the test failed before taking action
...
Registration Validation
    ...
    # NEW: Handle potential popups immediately
    Handle Ads Popup
    ...
    # FIX: Use JavaScript Click to bypass the ad iframe blocking the button
...
Search Validation
    Go To    ${BASE_URL}/shop/
    # Remove ads that block visibility
    Handle Ads Popup
    #assertions
    ...
    Wait Until Element Is Visible    css=ul.products    timeout=30s
